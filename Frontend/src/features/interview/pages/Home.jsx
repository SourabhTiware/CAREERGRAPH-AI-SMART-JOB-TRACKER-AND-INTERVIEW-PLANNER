...
const Home = () => {
    ...
    const handleCardClick = (id) => {
        localStorage.setItem('lastClickedReport', id);
...
useEffect(() => {
    ...
    const lastId = localStorage.getItem('lastClickedReport');
    
    if (lastId) {
        const timer = setTimeout(() => {
            const element = document.getElementById(`report-${lastId}`);
            if (element) {
                ...
                localStorage.removeItem('lastClickedReport');
            }
        }, 500); 
            ...
            <div className='interview-card'>
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--left'>
                        ...
                        <div className={`char-counter ${jobDescription.length === 5000 ? 'limit-reached' : ''}`}>{jobDescription.length} / 5000 chars</div>
                    </div>
